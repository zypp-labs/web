...
function FeatureCard({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "group relative w-full overflow-hidden rounded-3xl border border-black/10 bg-gradient-to-b from-[#163617] to-[#163617] transition duration-300 dark:from-[#163617] dark:to-[#163617]",
