...
>(({ className, children, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "rounded-[24px] dark:bg-neutral-800 bg-[#d7f7d0] p-2 no-underline shadow-sm transition-colors hover:bg-[#caf3c2] dark:hover:bg-neutral-800/80 ",
...
>(({ className, ...props }, ref) => (
    <h3
        ref={ref}
        className={cn("text-lg text-[#163617] tracking-tight my-2 font-semibold leading-tight px-1", className)}
        {...props}
    />
))
...
>(({ className, ...props }, ref) => (
    <p
        ref={ref}
        className={cn("text-sm text-[#163617]/80 tracking-tight pb-2 px-1", className)}
        {...props}
    />
))
